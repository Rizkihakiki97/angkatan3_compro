...
if (isset($_POST['kirim-bosss']) && isset($_GET['pesanId'])) {
    ...
    $headers = "From: mrizki.hakiki06@gmail.com" . "\r\n" .
        "Reply-To: mrizki.hakiki06@gmail.com" . "\r\n" .
    ...
    if (mail($email, $subject, $balaspesan, $headers)) {
        ...
        echo "Gagal";
        header("Location: kirim-pesan.php?status=gagal-kirim");
        exit();
    }
}
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">Balasan Pesan</div>
                                    <div class="card-body">
                                        <ul style="list-style-type: '-'">
                                            <li>
                                                <pre>Nama :<?php echo $rowContact['name'] ?></pre>
                                            </li>
                                            <li>
