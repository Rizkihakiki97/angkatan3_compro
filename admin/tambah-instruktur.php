...
if (isset($_POST['simpan'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            // pindahkan gambar dari temp folder ke folder yang sudah kita buat
...
if (isset($_POST['edit'])) {
    ...
    // jika user login memasukkan gambar
    if (!empty($_FILES['foto']['name'])) {
        $nama_foto = $_FILES['foto']['name'];
        $ukuran_foto = $_FILES['foto']['size'];
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="jurusan_instruktur" placeholder="Masukkan jurusan Instruktur Anda" required value="<?php echo isset($_GET['edit'])  ? $rowEdit['jurusan_instruktur'] : '' ?> ">
                                                </div>
                                            ...
                                            <!-- <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="password" name="password" placeholder="Masukkan Password Anda" <?php echo isset($_GET['edit']) ? '' : 'required' ?> class="form-control" id="">
                                                </div>
                                            </div> -->
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
